	...
	<div class="col-md-12 blog-content">
		<div class="blog-post">
			...
			<div class="blog-post-body">
				...
				<!-- Fim botão-->	
				<?php
				if(strpos($noticiaContent->imagem,'holanda_advogados')) {

				?>
					<div class="conteudo_blog">
					<!--<p style="padding-left: 30%"><img alt="{{$noticiaContent->titulo}}" src="{{url($noticiaContent->imagem)}}" style="width: 50%;"></p>-->
					<span><i class="fa fa-calendar"></i>{{Helpers::dateFormat($noticiaContent->created_at)}}</span>
					<br>
				...
				?>      
					<div class="conteudo_blog">
					<p><img alt="{{$noticiaContent->titulo}}" src="{{secure_asset('storage/public/' . $noticiaContent->imagem)}}" style="width: 100%;"></p>
					<span><i class="fa fa-calendar"></i>{{Helpers::dateFormat($noticiaContent->created_at)}}</span>
					<br>
					{!!$noticiaContent->texto!!}
					</div>
