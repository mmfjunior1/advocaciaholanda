		...
		<div class="blog-post">
			...
			<div class="blog-post-body">
				...
				<div class="conteudo_blog">
					<p><img alt="{{$noticia->titulo}}" src="{{url($noticia->imagem)}}" style="width: 100%;"></p>
					<span><i class="fa fa-calendar"></i>{{Helpers::dateFormat($noticia->created_at)}}</span>
					<br>
					{!!$noticia->texto!!}
				</div>
				...
				<!-- Botão Curtir Facebook-->	
					<div class="fb-like fb_iframe_widget" id="fb2" data-href="{{url('/')}}" data-layout="box_count" data-action="like" data-show-="" faces="false" data-share="true" href="{{url('/')}}/blog/noticias/{{Helpers::parseTitleInURL($noticia->titulo)}}.html" fb-xfbml-state="rendered" fb-iframe-plugin-query="action=like&app_id=&container_width=1040&href={{url('/')}}/blog/noticias/{{Helpers::parseTitleInURL($noticia->titulo)}}.html&layout=box_count&locale=pt_BR&sdk=joey&share=true"><span style="vertical-align: bottom; width: 79px; height: 64px;"><iframe name="f13b869b7e6c466" allowtransparency="true" allowfullscreen="true" scrolling="no" title="fb:like Facebook Social Plugin" style="border: medium none; visibility: visible; width: 79px; height: 64px;" src="https://www.facebook.com/v2.0/plugins/like.php?action=like&app_id=&channel=http%3A%2F%2Fstaticxx.facebook.com%2Fconnect%2Fxd_arbiter%2Fr%2F_dMxoUH0Bax.js%3Fversion%3D42%23cb%3Dfd4e14640149bc%26domain%3Dwww.feelgreat.com.br%26origin%3Dhttp%253A%252F%252Fwww.feelgreat.com.br%252Ff3b4cb22f2fbbea%26relation%3Dparent.parent&container_width=1040&href=http%3A%2F%2Fwww.feelgreat.com.br%2Fblog%2FVeja-8-raz%25C3%25B5es-para-come%25C3%25A7ar-a-fazer-yoga-em-casa-0-82&layout=box_count&locale=pt_BR&sdk=joey&share=true" class="" height="1000px" frameborder="0" width="1000px"></iframe></span></div>
				<!-- Fim botão-->
			<br><br>
			</div>
		</div>
