						...
						<input type="hidden" name="_token" value="<?php echo csrf_token() ?>">
                            ...
                            <div class="row">
								<div class="form-group col-sm-7">
                                    ...
                                    <button style="background:#fff;color:#555555" type="button" id="btn_front_search" name="btn_front_search" class="send-now"><i class="fa fa-envelope fa-2x"></i>&nbsp;Enviar</button>
                                </div>
                            </div>
						</form>                           
                      </fieldset>
